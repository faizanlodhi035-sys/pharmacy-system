        ...
        <div class="md:col-span-7 p-8 md:p-12 lg:p-14 flex flex-col justify-center bg-white">
            ...
            <div class="max-w-md w-full mx-auto">
                ...
                <div class="relative flex items-center justify-center my-6">
                    ...
                    <span class="bg-white px-4 text-xs font-medium text-slate-400 absolute uppercase tracking-wider">or</span>
                </div>

                <!-- Secondary Button (Firebase / Google Login) -->
                <button id="firebase-google-btn" 
                        onclick="window.loginWithFirebaseGoogle()" 
                        type="button" 
                        class="w-full flex items-center justify-center gap-3 bg-white border border-slate-200 text-slate-700 py-3 px-4 rounded-xl font-medium hover:bg-slate-50 hover:border-slate-300 transition shadow-sm cursor-pointer text-sm">
                ...
                <div class="mt-8 text-center pt-2">
                    ...
                    <p class="text-xs text-slate-400 mt-2">Your data is protected and safe with us.</p>
                </div>
