...
<div class="space-y-6 max-w-5xl mx-auto py-6">
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-xl p-6 shadow-sm">
        ...
        <div class="flex flex-col sm:flex-row gap-4">
            ...
            <form action="{{ route('admin.migration.dry_run') }}" method="POST">
                @csrf
            ...
            <form action="{{ route('admin.migration.real_transfer') }}" method="POST" onsubmit="return confirm('Are you sure you want to run the REAL transfer? This will upsert data into the production database.');">
                @csrf
